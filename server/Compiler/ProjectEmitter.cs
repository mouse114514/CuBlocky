...
public static class ProjectEmitter
{
    ...
    public static Dictionary<string, string> EmitProject(Blueprint bp, string? gamePath = null)
    {
        ...
        {
            ["Plugin.cs"] = EmitPlugin(ns, guid, name, ver, desc, hasEvents, hasStatuses),
    ...
    private static string EmitPlugin(string ns, string guid, string name, string ver, string desc, bool hasEvents, bool hasStatuses)
    {
