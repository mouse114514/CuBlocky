...
";
    ...
    private static string EmitCuUI(string ns, List<UIControlEntry> controls)
    {
        ...
        sb.AppendLine("            public float X, Y, Width, Height; // percentages 0-1");
        ...
        sb.AppendLine("        private static Texture2D _whiteTex;");
        sb.AppendLine();
        ...
        foreach (var c in controls)
        {
            ...
            sb.AppendLine($"            _controls[\"{id}\"] = new Ctrl {{ Id = \"{id}\", Type = \"{c.Type}\", X = {c.X}f, Y = {c.Y}f, Width = {c.Width}f, Height = {c.Height}f, Text = \"{text}\", FontSize = {c.FontSize}, TextColor = {tc}, BgColor = {bg}, Opacity = {c.Opacity}f, Visible = {c.Visible.ToString().ToLower()}, TextFieldText = \"{text}\" }};");
        }
        ...
        sb.AppendLine("        {");
        sb.AppendLine("            InitData();");
        sb.AppendLine("            if (_whiteTex == null) _whiteTex = Texture2D.whiteTexture;");
        ...
        sb.AppendLine("                _style.normal.background = _whiteTex;");
        sb.AppendLine("                _style.hover.background = _whiteTex;");
        sb.AppendLine("                _style.active.background = _whiteTex;");
        sb.AppendLine("                _style.onNormal.background = _whiteTex;");
        sb.AppendLine("                _style.onHover.background = _whiteTex;");
        sb.AppendLine("                _style.onActive.background = _whiteTex;");
        sb.AppendLine("            }");
        ...
        sb.AppendLine("                var oldBg = GUI.backgroundColor;");
        ...
        sb.AppendLine("                GUI.backgroundColor = oldBg;");
        sb.AppendLine("            }");
        sb.AppendLine("        }");
        sb.AppendLine();
