...
const MSG_RU: Record<string, string> = {
  ...
  CU_WHEN_PICKUP: 'при подборе предмета',
  CU_WHEN_DROP: 'при броске предмета',
  CU_WHEN_WEAR: 'при надевании снаряжения',
  CU_WHEN_HEAL: 'при лечении',
  CU_WHEN_LASTSTAND: 'при последнем всплеске',
  CU_WHEN_ENTER_WORLD: 'при входе в мир',
  CU_REGISTER_ITEM: 'зарегистрировать предмет id %1 имя %2 описание %3 спрайт %4',
  CU_SPRITE_REF: 'спрайт %1',
  CU_REGISTER_STATUS: 'зарегистрировать эффект id %1 имя %2 тип %3 описание %4 спрайт %5',
  CU_STATUS_REF: 'статус %1',
  CU_STATUS_GET: '%2 статуса %1',
  CU_STATUS_SET: 'установить статус %1 уровень %2 на %3',
  CU_DEFINE_ITEM_USE: 'при использовании предмета %1',
  CU_DEFINE_ITEM_LIMB_USE: 'при использовании предмета %1 на конечность',
  CU_ITEM_SET_PROPERTY: 'установить предмету %1 свойство %2 значение %3',
  CU_ITEM_SET_TAG: 'установить предмету %1 тег %2',
  CU_ITEM_SET_START_CONDITION: 'установить предмету %1 стартовое состояние %2',
  CU_REGISTER_RECIPE: 'рецепт %1 → %2 ×%3 сост%4 ингред.сост%5 ремонт%6 интеллект%7',
  CU_EAT: 'есть голод %1 прирост веса %2',
  CU_DRINK: 'пить количество %1',
  CU_SET_HAPPINESS: 'установить счастье %1',
  CU_SET_TEMPERATURE: 'установить температуру %1',
  CU_TALK: 'говорить %1',
  CU_RUN_COMMAND: 'выполнить команду %1',
  CU_SET_PAIN: 'установить боль %1',
  CU_SET_STRESS: 'установить стресс %1',
  ...
  CU_ITEM_CONSUME: 'расходовать %1 предмет кол-во %2',
  CU_ITEM_SET_CONDITION: 'установить %1 предмету состояние %2 %3',
  CU_ITEM_SET_WEIGHT: 'установить %1 предмету вес %2',
  CU_ITEM_SET_VALUE: 'установить %1 предмету стоимость %2',
  CU_ITEM_SET_DECAY: 'установить %1 время порчи %2',
  CU_ITEM_SET_SLOT_ROTATION: 'установить %1 поворот слота %2',
  CU_PLAY_SOUND: 'воспроизвести звук %1',
  CU_PLAY_SOUND_AT: 'воспроизвести звук %1 на(%2,%3) громкость%4',
  CU_IF: 'если %1 то',
  CU_ELSE: 'иначе',
  CU_REPEAT: 'повторить %1 раз',
  CU_WHILE: 'пока %1 повторять',
  CU_FOR_LOOP: 'для %1 = %2 до %3 повторять',
  CU_HAPPINESS: 'счастье',
  CU_TEMPERATURE: 'температура',
  CU_HUNGER: 'голод',
  CU_WEIGHT: 'вес',
  CU_POSITION_X: 'позиция x',
  CU_POSITION_Y: 'позиция y',
  CU_ITEM_CONDITION: 'состояние предмета',
  CU_ITEM_NAME: 'название предмета',
  CU_WORLD_TIME: 'время мира',
  CU_WORLD_BLOCK_AT: 'блок на',
  ...
  CU_REGISTER_BUILDING: 'зарегистрировать здание id %1 имя %2 описание %3',
  CU_BUILDING_SET_PROPERTY: 'здание %1 установить %2 значение %3',
  CU_REGISTER_TILE: 'зарегистрировать плитку id %1 имя %2 описание %3',
  CU_TILE_SET_PROPERTY: 'плитка %1 установить %2 значение %3',
  CU_REGISTER_LOCALE: 'локализация %1 id %2 ru %3 en %4',
  CU_PLAYER_HEALTH: 'здоровье игрока',
  CU_PLAYER_MAX_HEALTH: 'макс. здоровье',
  CU_PLAYER_STAMINA: 'выносливость',
  CU_PLAYER_OXYGEN: 'кислород',
  CU_PLAYER_SLEEP_QUALITY: 'качество сна',
  CU_PLAYER_PAIN: 'боль',
  CU_PLAYER_STRESS: 'стресс',
  CU_PLAYER_HEART_RATE: 'пульс',
  CU_PLAYER_BLOOD_PRESSURE: 'давление',
  CU_PLAYER_IMMUNITY: 'иммунитет',
  CU_PLAYER_THIRST: 'жажда',
  CU_PLAYER_STR: 'СИЛ игрока',
  CU_PLAYER_RES: 'ВОС игрока',
  CU_PLAYER_INT_SKILL: 'ИНТ игрока',
  CU_PLAYER_EXP_STR: 'опыт СИЛ',
  CU_PLAYER_EXP_RES: 'опыт ВОС',
  CU_PLAYER_EXP_INT: 'опыт ИНТ',
  CU_ITEM_MAX_CONDITION: 'макс. состояние предмета',
  CU_ITEM_WEIGHT: 'вес предмета',
  CU_ITEM_VALUE: 'стоимость предмета',
  CU_WORLD_SET_TILE: 'установить плитку X %1 Y %2 на %3',
  ...
  CU_GIVE_ITEM: 'выдать игроку предмет %1 ×%2',
  CU_GIVE_ITEM_SLOT: 'выдать игроку предмет %1 в слот %2 ×%3',
  CU_MATH_CLAMP: 'ограничить %1 между %2 и %3',
  CU_ITEM_IS_EQUIPPED: 'предмет экипирован',
  CU_ITEM_IS_IN_INVENTORY: 'предмет в инвентаре',
  CU_ITEM_CUSTOM: 'пользовательский предмет',
  CU_ITEM_VANILLA: 'предмет',
  CU_LIMB_INDEX: 'конечность',
  CU_PLAYER_ENERGY: 'энергия',
  CU_PLAYER_BRAIN_HEALTH: 'здоровье мозга',
  CU_PLAYER_SHOCK: 'шок',
  CU_PLAYER_BLOOD_VOLUME: 'объём крови',
  CU_PLAYER_RESPIRATORY_RATE: 'частота дыхания',
  CU_PLAYER_SICKNESS: 'болезненность',
  ...
  CU_PLAYER_BLEED_SPEED: 'скорость кровотечения',
  CU_PLAYER_CONSCIOUS: 'игрок в сознании',
  CU_PLAYER_STANDING: 'игрок стоит',
  CU_PLAYER_GROUNDED: 'игрок на земле',
  CU_PLAYER_IN_WATER: 'игрок в воде',
  CU_PLAYER_BREATHING: 'игрок дышит',
  CU_PLAYER_CROUCHING: 'игрок приседает',
  CU_SET_ENERGY: 'установить энергию %1',
  CU_SET_BRAIN_HEALTH: 'установить здоровье мозга %1',
  CU_SET_SHOCK: 'установить шок %1',
  CU_SET_BLOOD_VOLUME: 'установить объём крови %1',
  CU_SET_SICKNESS: 'установить болезненность %1',
  ...
  CU_LIMB_SKIN_HEALTH: 'здоровье кожи конечности',
  CU_LIMB_MUSCLE_HEALTH: 'здоровье мышц конечности',
  ...
  CU_LIMB_DISMEMBERED: 'конечность отсечена',
  ...
  CU_SET_LIMB_BLEED: 'установить кровотечение',
  CU_LIMB_BREAK: 'сломать конечность',
  CU_LIMB_MEND: 'лечить конечность',
  CU_LIMB_DISLOCATE: 'вывихнуть конечность',
  CU_LIMB_UNDISLOCATE: 'вправить конечность',
  CU_LIMB_DISMEMBER: 'отсечь конечность',
  CU_ITEM_ID: 'id предмета',
  CU_ITEM_CATEGORY: 'категория предмета',
  CU_WORLD_DEPTH: 'глубина игрока (метры)',
  CU_SET_ITEM_CATEGORY: 'установить предмету id %1 категорию %2',
  CU_SET_ITEM_BASE_STATS: 'установить базовые характеристики id %1 вес %2 стоимость %3 порча %4 мин %5 распознавание %6 частота появления %7',
  CU_ITEM_CONTAINER: 'установить свойства контейнера\nid %1 вместимость %2 макс. вес %3 нагрузка %4 видимость %5 ограничение тегов %6',
  CU_ITEM_TOOL: 'установить свойства оружия/инструмента\nid %1 урон %2 структурный %3 дистанция %4 отброс %5 перезарядка %6 выносливость %7 пробивание %8',
  CU_ITEM_WEARABLE: 'установить свойства одежды\nid %1 конечность %2 слот %3 броня %4 изоляция %5 потеря прочности %6',
  CU_REGISTER_LIQUID: 'зарегистрировать жидкость id %1 имя %2 описание %3',
  ...
  CU_LIQUID_FLAGS: 'флаги жидкости\nid %1\nпитьевая %2\nмедицинская %3\nинъекционная %4\nинъекционная тошнота %5\nнедоступная %6',
  CU_ITEM_LIQUID_CONTAINER: 'установить контейнер жидкости\nid %1 вместимость %2 автозаполнение %3 id жидкости %4 количество %5',
  CU_ITEM_BATTERY: 'установить свойства батареи\nid %1 пресет %2 начальный заряд %3.spawn с батареей %4',
  CU_ITEM_LIGHT: 'установить свет id %1 интенсивность %2 радиус %3 R %4 G %5 B %6',
  CU_ITEM_BANDAGE: 'установить пластырь id %1 эффективность %2 заживление кожи %3 замедление пластыря %4 боль %5 кость %6 вывих %7',
  CU_ITEM_SYRINGE: 'установить шприц\nid %1 вместимость %2 за использование %3 автозаполнение %4 id жидкости %5 количество %6',
  CU_ITEM_GUN: 'установить свойства оружия\nid %1 тип патронов %2 режим огня %3 тип подачи %4 вместимость магазина %5 урон по животным %6 структурный %7 отброс %8 потеря состояния %9 громкость %10 время газа %11 выстрелов за раз %12 вертикальный разброс %13 спрайт заряжания %14.normal без мага %15.racked без мага %16 звук выстрела %17 звук заряжания %18 звук разрядки %19',
  CU_ITEM_MAGAZINE: 'установить магазин\nid %1 тип патронов %2 макс. патронов %3 стартовые патроны %4',
  CU_PARAM: 'параметр %1 тип %2',
  CU_DEFINE_FUNCTION: 'определить функцию %1 возврат %2',
  CU_DEFINE_FUNCTION_CONTAINER: 'параметры',
  CU_DEFINE_FUNCTION_ITEM: 'параметр',
  CU_RETURN: 'вернуть %1',
  CU_GET_PARAM: 'параметр %1',
  CU_CALL_FUNCTION: 'вызвать %1',
  CU_CALL_FUNCTION_VALUE: 'вызвать %1',
  CU_CALL_FUNCTION_CONTAINER: 'аргументы',
  CU_CALL_FUNCTION_ITEM: 'аргумент',
};
