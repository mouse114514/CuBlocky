...
const dict = {
  ...
  'app.noProjects':    { zh: '暂无项目', en: 'No projects yet' },
  'app.placeholder.name': { zh: '请在此处输入项目名称', en: 'Enter project name here' },
  'app.placeholder.guid': { zh: '例如 com.author.modname', en: 'e.g. com.author.modname' },
  'app.placeholder.desc': { zh: '可选，简要说明插件功能', en: 'Optional, brief description' },
