...
const dict = {
  ...
  'item.decay':        { zh: '腐烂时间(分钟)', en: 'Decay Minutes', ru: 'Время порчи (мин)' },
  ...
  'item.onUseHint':    { zh: '切换到"使用行为"积木画布编辑效果', en: 'Switch to "On Use" blocks canvas to edit behavior', ru: 'Переключитесь на canvas "При использовании" для редактирования' },
  'item.onUseLimbHint':{ zh: '切换到"肢体使用行为"积木画布编辑效果', en: 'Switch to "On Use Limb" blocks canvas to edit behavior', ru: 'Переключитесь на canvas "На конечности" для редактирования' },
  'item.delete':       { zh: '删除物品', en: 'Delete Item', ru: 'Удалить предмет' },
  'item.spriteHint':   { zh: '贴图名称: 自动生成为 {id}.png', en: 'Sprite name: auto-generated as {id}.png', ru: 'Имя спрайта: автоматически {id}.png' },
  ...
  'recipe.liquid':     { zh: '液体产出', en: 'Liquid Result', ru: 'Жидкий результат' },
  ...
  'block.indent':      { zh: '缩进', en: 'Indent', ru: 'Увеличить отступ' },
  'block.outdent':     { zh: '取消缩进', en: 'Outdent', ru: 'Уменьшить отступ' },
  'block.empty':       { zh: '暂无积木，从左侧积木库拖入', en: 'No blocks yet. Click a block in the palette to add.', ru: 'Блоков нет. Нажмите на блок в палитре, чтобы добавить.' },
  ...
  // ── Block names ──
  'block.eat':              { zh: '吃 (饥饿, 体重增益)', en: 'Eat (hunger, weightGain)', ru: 'Есть (голод, вес)' },
  'block.drink':            { zh: '喝水 (量)', en: 'Drink (amount)', ru: 'Пить (количество)' },
  ...
  'block.setCondition':     { zh: '设置 物品耐久', en: 'Set Item Condition', ru: 'Установить состояние предмета' },
  'block.soundPlayBody':    { zh: '播放音效 (身体位置)', en: 'Play Sound (body pos)', ru: 'Воспроизвести звук (позиция тела)' },
  'block.soundPlayItem':    { zh: '播放音效 (物品位置)', en: 'Play Sound (item pos)', ru: 'Воспроизвести звук (позиция предмета)' },
...
export function I18nProvider({ children }: { children: ReactNode }) {
  const [lang, setLang] = useState<Lang>(() => {
    const saved = localStorage.getItem('cublocky-lang');
