...
";
    ...
    private static string EmitCuUI(string ns, List<UIControlEntry> controls)
    {
        ...
        sb.AppendLine("        private static GUIStyle _buttonStyle;");
        sb.AppendLine();
        ...
        sb.AppendLine("            }");
        sb.AppendLine("            if (_buttonStyle == null)");
        sb.AppendLine("            {");
        sb.AppendLine("                _buttonStyle = new GUIStyle(GUI.skin.button);");
        sb.AppendLine("                _buttonStyle.alignment = TextAnchor.MiddleCenter;");
        sb.AppendLine("                _buttonStyle.normal.textColor = Color.white;");
        sb.AppendLine("                var btnTex = GetNineSliceTex(20f);");
        sb.AppendLine("                _buttonStyle.normal.background = btnTex;");
        sb.AppendLine("                _buttonStyle.border = new RectOffset(20, 20, 20, 20);");
        sb.AppendLine("            }");
        ...
        sb.AppendLine();
                sb.AppendLine("                if (c.Type == \"button\")");
        sb.AppendLine("                {");
        sb.AppendLine("                    _buttonStyle.fontSize = Mathf.RoundToInt(c.FontSize * sc);");
        sb.AppendLine("                    _buttonStyle.normal.textColor = Color.white;");
        sb.AppendLine("                    int br = Mathf.RoundToInt(Mathf.Max(20f, c.CornerRadius) * sc);");
        sb.AppendLine("                    var btnBg = GetNineSliceTex(Mathf.Max(20f, c.CornerRadius) * sc);");
        sb.AppendLine("                    _buttonStyle.normal.background = btnBg;");
        sb.AppendLine("                    _buttonStyle.border = new RectOffset(br, br, br, br);");
        sb.AppendLine("                    GUI.backgroundColor = Color.black;");
        sb.AppendLine("                    if (GUI.Button(rect, c.Text, _buttonStyle) && _buttonCallbacks.TryGetValue(c.Id, out var cb)) cb();");
        sb.AppendLine("                }");
