...
";
    ...
    private static string EmitCuUI(string ns, List<UIControlEntry> controls)
    {
        ...
        sb.AppendLine("                var bgTex = c.CornerRadius > 0 ? GetNineSliceTex(c.CornerRadius * sc) : GetTex(c.BgColor);");
        ...
        sb.AppendLine("                else");
        sb.AppendLine("                {");
        sb.AppendLine("                    var bgTex = GetTex(c.BgColor);");
        sb.AppendLine("                    GUI.DrawTexture(rect, bgTex);");
        sb.AppendLine("                }");
        sb.AppendLine();
